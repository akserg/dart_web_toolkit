...
part 'src/shared/adapter/blur_handler_adapter.dart';
part 'src/shared/adapter/change_handler_adapter.dart';
part 'src/shared/adapter/click_handler_adapter.dart';
part 'src/shared/adapter/double_click_handler_adapter.dart';
part 'src/shared/adapter/drag_end_handler_adapter.dart';
part 'src/shared/adapter/drag_enter_handler_adapter.dart';
part 'src/shared/adapter/drag_handler_adapter.dart';
part 'src/shared/adapter/drag_leave_handler_adapter.dart';
part 'src/shared/adapter/drag_over_handler_adapter.dart';
part 'src/shared/adapter/drag_start_handler_adapter.dart';
part 'src/shared/adapter/drop_handler_adapter.dart';
part 'src/shared/adapter/error_handler_adapter.dart';
part 'src/shared/adapter/focus_handler_adapter.dart';
part 'src/shared/adapter/gesture_change_handler_adapter.dart';
part 'src/shared/adapter/gesture_end_handler_adapter.dart';
part 'src/shared/adapter/gesture_start_handler_adapter.dart';
part 'src/shared/adapter/key_down_handler_adapter.dart';
part 'src/shared/adapter/key_press_handler_adapter.dart';
part 'src/shared/adapter/key_up_handler_adapter.dart';
part 'src/shared/adapter/load_handler_adapter.dart';
part 'src/shared/adapter/mouse_down_handler_adapter.dart';
part 'src/shared/adapter/mouse_move_handler_adapter.dart';
part 'src/shared/adapter/mouse_out_handler_adapter.dart';
part 'src/shared/adapter/mouse_over_handler_adapter.dart';
part 'src/shared/adapter/mouse_up_handler_adapter.dart';
part 'src/shared/adapter/mouse_wheel_handler_adapter.dart';
part 'src/shared/adapter/scroll_handler_adapter.dart';
part 'src/shared/adapter/touch_cancel_handler_adapter.dart';
part 'src/shared/adapter/touch_end_handler_adapter.dart';
part 'src/shared/adapter/touch_move_handler_adapter.dart';
part 'src/shared/adapter/touch_start_handler_adapter.dart';
