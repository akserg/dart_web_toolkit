 ...
 */
class GestureChangeHandlerAdapter extends EventHandlerAdapter implements GestureChangeHandler {

  GestureChangeHandlerAdapter(EventHandlerAdapterCallback callback) : super(callback);
